...
impl SettingsField {
    ...
    pub fn label_key(&self) -> &str {
        match self {
            ...
            Self::FolderPreventDuplicateUrl => "settings-folder-prevent-duplicate-url",
    ...
    pub fn description_key(&self) -> &str {
        match self {
            ...
            Self::FolderPreventDuplicateUrl => "settings-folder-prevent-duplicate-url-desc",
